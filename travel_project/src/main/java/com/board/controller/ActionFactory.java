...
import com.board.controller.action.BoardCommentDeleteAction;
import com.board.controller.action.BoardCommentInsertAction;
...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		} else if (command.equals("board_comment_insert")) {
			action = new BoardCommentInsertAction();
			System.out.println("commentinsertaction 함수 실행");
