	...
	<div class="container" style="position: relative;">
		...
		<form name="frm" method="post" action="BoardServlet" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<tr>
					<th> 제목 </th>
					<td> <input class="form-control" placeholder="제목" aria-label="제목" type="text" name="title" value="${board.title }"> </td>
				</tr>
				<tr>
					<th> 파일 </th>
				...
				<tr>
					<th> 내용 </th>
					<td> <textarea class="form-control" placeholder="내용" id="content" name="content">${board.content }</textarea> </td>
				</tr>
			</table>
			<br><br>
			...
			<input type="submit" class="btn btn-light" value="수정" onclick="return boardCheck()" style="float: right; background: white;">
